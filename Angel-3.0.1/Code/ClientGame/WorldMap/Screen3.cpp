...
void Screen3::Start()
{
    ...
    m_door = new DoorActor("Resources/Images/Door/",GetBitmask("Resources/Images/Door/maskOpen.png"),GetBitmask("Resources/Images/Door/maskClosed.png"),Vector2(10,0),Vector2(1.0f,2.0f),buttons);
